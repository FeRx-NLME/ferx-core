...
(e.g. subject 7) and used fixed-EBE outer gradients, which omit the EBE-response term
the analytic gradient carries. If the fit stalls, `reconverge_gradient_interval = N`
restores the reconverged gradient every N-th evaluation. The reported outer gradient
