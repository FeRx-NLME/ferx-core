...
The damping is applied only when NLopt actually has a θ to estimate. A fit whose
every theta is mu-referenced or `FIX` is unaffected, down to the last bit — and
