...
- **`MIXNUM`-switched class typical values**, and log-mu-referenced thetas
  dropped to the identity scale by a negative lower bound. These carry an eta in
...
|---|---:|---:|---:|---:|
| `LOGIT_FR1` | 0.4055 | 0.2462 | 0.3793 | NONMEM_LOGIT_FR1_PLACEHOLDER |
| `FR1` = `inv_logit(LOGIT_FR1)` | 0.600 | 0.561 | 0.594 | NONMEM_FR1_PLACEHOLDER |
| `ω²(ETA_FR1)` (logit scale) | 0.25 | 0.326 | 0.186 | NONMEM_OMEGA_PLACEHOLDER |
| `CL` | 5.0 | 5.35 | 5.31 | NONMEM_CL_PLACEHOLDER |
| `V` | 50.0 | 51.4 | 54.6 | NONMEM_V_PLACEHOLDER |
