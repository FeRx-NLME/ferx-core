...
- The model is inside the analytic covariance scope shared with FOCE/FOCEI — no
  censored (M3/BLOQ) observations, and a Gaussian endpoint the sensitivity
  provider reaches. TTE, categorical endpoints, and custom or time-varying residual
...
- **Production covariance dispatch** — FOCE, FOCEI, and AGQ-FOCEI standard errors are
  ...
  analytic dispatcher accepts each fixture, rejects exact-anchor Laplace, and declines
  a population containing a censored subject.
