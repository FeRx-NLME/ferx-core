...
> **An integer column may be float-formatted.** pandas and R write a whole
> integer column as `1.0`, `2.0`, … once any cell in it is blank, and ferx's own
> sdtab writes `CENS` as `1.000000`. Every integer column above, `ADDL`, the
