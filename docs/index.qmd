...
| License | MIT | Commercial | GPL (≥ 3) | Commercial | Commercial |
...
availability only, as documented by each tool (checked September 2026). It does
not rank how each engine computes gradients, which differs by method and option;
for ferx's own approach see
