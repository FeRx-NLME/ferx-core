...
| Stiff ODE steppers (`ode_method` = Rosenbrock23 / Rodas4 / Rodas5P) | **beta** | [Stiff systems](model-file/ode-models.qmd#stiff-systems) |
| High-order ODE stepper (`ode_method` = Vern7) | **experimental** | [Choosing a method](model-file/ode-models.qmd#stiff-systems) |
| Automatic stiff-solver selection (`ode_method = auto`, the default) | **beta** | [Letting ferx pick the stepper](model-file/ode-models.qmd#letting-ferx-pick-the-stepper-ode_method--auto) |
