...
per observation. Two cases currently fall back to finite differences — correct,
just slower, and reported honestly as FD rather than claimed as analytic:

- inter-occasion variability (a `kappa` in the model), and
- more than 24 estimated `(θ, η)` in total.
