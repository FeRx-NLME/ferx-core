...
| `time(t₁, t₂, …)` | Time-window breakpoints. The strictly-increasing edges define bins: `time(24, 48)` → occasion 0 for `TIME < 24`, occasion 1 for `24 ≤ TIME < 48`, occasion 2 for `TIME ≥ 48`. |
