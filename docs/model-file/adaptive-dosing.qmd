...
- **Pre-scheduled base regimens are supported** (#702) — the base subject may carry a
  ...
  *Scope:* supported on constant-covariate, non-reset models — a base regimen combined with
  time-varying covariates, IOV, or system resets (EVID=3/4) is a typed error (each a #702
  follow-up), never a silent mis-integration of a delivered dose.
