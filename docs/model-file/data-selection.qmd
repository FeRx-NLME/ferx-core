...
Reader warnings raised while the clauses are compiled reach the check too —
`W_FILTER_COLUMN_ABSENT` for a condition naming a column the file does not have,
under its own code in the [check report](../file-formats/check-report.qmd).
