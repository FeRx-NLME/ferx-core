...
sample size, stratification column, `--keep-covariance` / `--dofv`, the parameter names,
and SHA-256 hashes of the model file and the dataset. A `--resume` whose options or inputs
disagree is refused, naming the field that differs:
