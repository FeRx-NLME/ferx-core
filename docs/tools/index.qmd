...
- **[Global model search](global-search.qmd)** — pyDarwin's genetic
  algorithm or exhaustive enumeration over one grid of structural and
  covariate choices, ranked on pyDarwin's penalized fitness; for the model
  spaces whose axes interact, where a stepwise search can lock in a local
  optimum.
