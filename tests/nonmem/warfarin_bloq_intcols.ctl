$PROBLEM Warfarin M3 BLOQ, integer columns written as integers (ferx-core #1496)
...
$DATA warfarin_bloq_intcols.csv IGNORE=@
...
$TABLE ID TIME IPRED CENS NOPRINT ONEHEADER FILE=sdtab_bloq_intcols
