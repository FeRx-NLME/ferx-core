$PROBLEM #1060 anchor C - B plus a record between the dose row and the lagged arrival
$INPUT ID TIME DV AMT EVID CMT MDV WT
$DATA tvcov_lag_saltation_md_shrink.csv IGNORE=@
...
$TABLE ID TIME WT DV IPRED CL V KA ALAG1 ETA1 ETA2 ETA3
       ONEHEADER NOPRINT FILE=tvcov_lag_saltation_md_shrink.tab
