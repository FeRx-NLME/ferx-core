$PROBLEM #1060 anchor B - 2nd dose arrival crosses a covariate change with residual drug
$INPUT ID TIME DV AMT EVID CMT MDV WT
$DATA tvcov_lag_saltation_multidose.csv IGNORE=@
...
$TABLE ID TIME WT DV IPRED CL V KA ALAG1 ETA1 ETA2 ETA3
       ONEHEADER NOPRINT FILE=tvcov_lag_saltation_multidose.tab
