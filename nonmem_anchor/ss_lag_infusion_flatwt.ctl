$PROBLEM #1121 review F1 - SS infusion whose PREVIOUS cycle is still running at the record
$INPUT ID TIME DV AMT RATE EVID CMT MDV WT SS II LG
$DATA ss_lag_infusion_flatwt.csv IGNORE=@
...
$TABLE ID TIME WT DV IPRED CL V ALAG1
       ONEHEADER NOPRINT FILE=ss_lag_infusion_flatwt.tab
