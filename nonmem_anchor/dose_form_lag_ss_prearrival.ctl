$PROBLEM #1121 E3P - SS + ALAG1 with a sample INSIDE the pre-arrival window
$INPUT ID TIME DV AMT EVID CMT MDV WT SS II
$DATA dose_form_lag_ss_prearrival.csv IGNORE=@
...
$TABLE ID TIME WT DV IPRED CL V KA ALAG1 ETA1 ETA2 ETA3
       ONEHEADER NOPRINT FILE=dose_form_lag_ss_prearrival.tab
