$PROBLEM SS dose x ODE-accumulated hazard (#1210) -- r3_const: mid-record second SS dose
$INPUT ID TIME DV EVID AMT CMT RATE MDV SS II
$DATA train3.csv IGNORE=@
...
$TABLE ID TIME CMT DV EVID IPRED CHZ HAZ MDV NOPRINT ONEHEADER NOAPPEND FORMAT=s1PE15.8 FILE=ss_chz_r3_const.tab
