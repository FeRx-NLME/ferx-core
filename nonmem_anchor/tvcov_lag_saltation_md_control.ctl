$PROBLEM #1060 anchor D - control: dose row carries the SAME WT as the next record
$INPUT ID TIME DV AMT EVID CMT MDV WT
$DATA tvcov_lag_saltation_md_control.csv IGNORE=@
...
$TABLE ID TIME WT DV IPRED CL V KA ALAG1 ETA1 ETA2 ETA3
       ONEHEADER NOPRINT FILE=tvcov_lag_saltation_md_control.tab
