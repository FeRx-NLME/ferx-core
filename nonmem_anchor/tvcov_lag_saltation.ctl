$PROBLEM #1060 anchor A - single dose, lagged arrival crosses a covariate change
$INPUT ID TIME DV AMT EVID CMT MDV WT
$DATA tvcov_lag_saltation.csv IGNORE=@
...
$TABLE ID TIME WT DV IPRED CL V KA ALAG1 ETA1 ETA2 ETA3
       ONEHEADER NOPRINT FILE=tvcov_lag_saltation.tab
