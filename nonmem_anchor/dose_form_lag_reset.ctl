$PROBLEM #1073 E4 - EVID=4 reset+dose + ALAG1; reset, dose record and arrival are three instants
$INPUT ID TIME DV AMT EVID CMT MDV WT
$DATA dose_form_lag_reset.csv IGNORE=@
...
$TABLE ID TIME WT DV IPRED CL V KA ALAG1 ETA1 ETA2 ETA3
       ONEHEADER NOPRINT FILE=dose_form_lag_reset.tab
