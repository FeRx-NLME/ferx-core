$PROBLEM #1073 E3b CONTROL - SS + TV covariate, NO lagtime (isolates the covariate from the lagtime)
$INPUT ID TIME DV AMT EVID CMT MDV WT SS II
$DATA dose_form_lag_ss.csv IGNORE=@
...
$TABLE ID TIME WT DV IPRED CL V KA ALAG1 ETA1 ETA2 ETA3
       ONEHEADER NOPRINT FILE=dose_form_lag_ss_nolag.tab
