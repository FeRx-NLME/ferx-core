$PROBLEM #1121 E3B - SS=1 record mid-stream (not first) with ALAG1, sample inside its pre-arrival window
$INPUT ID TIME DV AMT EVID CMT MDV WT SS II
$DATA dose_form_lag_ss_midstream.csv IGNORE=@
...
$TABLE ID TIME WT DV IPRED CL V KA ALAG1 ETA1 ETA2 ETA3
       ONEHEADER NOPRINT FILE=dose_form_lag_ss_midstream.tab
