$PROBLEM NULL TWIN of additive (+) covariate effect on CL (#1313 anchor, arm A)
...
$THETA
  ...
  (1.0, 80.0, 500.0)   ; TVV2
  (0.01, 1.0, 10.0)    ; TVKA
  0 FIX                ; THETA_CL_WT held at zero — the null twin
...
$TABLE ID TIME PRED IPRED NOPRINT ONEHEADER FILE=additive_cov_lin_null.tab FORMAT=s1PE23.16
