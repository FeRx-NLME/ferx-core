$PROBLEM SS dose x ODE-accumulated hazard (#1210) -- r3_drug: mid-record second SS dose
...
$TABLE ID TIME CMT DV EVID IPRED CHZ HAZ MDV NOPRINT ONEHEADER NOAPPEND FORMAT=s1PE15.8 FILE=ss_chz_r3_drug.tab
