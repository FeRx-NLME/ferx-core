$PROBLEM #1124 deterministic variant -- OMEGA 0 FIX, settles the $DES TAD construction
...
$THETA
 ...
 (0.0,   0.3)   ; THETA_TAD
$OMEGA
 0 FIX  ; ETA_CL -- deterministic variant: IPRED is a pure function of THETA
$SIGMA
 0.01   ; proportional, variance
$ESTIMATION METHOD=1 INTERACTION MAXEVAL=0 POSTHOC PRINT=1
$TABLE ID TIME IPRED CWRES NOPRINT ONEHEADER FILE=mr_tad_det.tab
