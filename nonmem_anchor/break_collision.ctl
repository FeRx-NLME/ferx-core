$PROBLEM #1186 break-time collision twin: depot <- first_order(ka, lag=LAGR) with ALAG1=LAGC; central boluses at 0 and 8.2
...
$DATA break_collision.csv IGNORE=@
...
$TABLE ID TIME PRED IPRED CMT EVID NOPRINT ONEHEADER FORMAT=s1PE15.8 FILE=break_collision.tab
