$PROBLEM multiplicative AND additive covariate effects on one CL (#1313 anchor, arm B)
...
$THETA
  ...
  (-1.0, 0.02, 1.0)    ; THETA_CL_CRCL, the additive slope
...
$TABLE ID TIME PRED IPRED NOPRINT ONEHEADER FILE=additive_cov_mixed.tab FORMAT=s1PE23.16
