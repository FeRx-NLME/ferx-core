$PROBLEM ferx #1133 anchor A -- A_0 re-seed at an EVID=3/4 reset: whose $PK snapshot?
; WT steps 70 -> 140 AT the reset row and stays there (the natural LOCF shape).
...
$TABLE ID TIME WT IPRED NOPRINT ONEHEADER FORMAT=s1PE17.10 FILE=reset_init_snapshot_A.tab
